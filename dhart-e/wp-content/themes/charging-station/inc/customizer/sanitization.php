 ...
 */
function chargingstation_sanitize_checkbox( $checked ) {
	// Boolean check.
	return ( ( isset( $checked ) && true == $checked ) ? true : false );
}


function chargingstation_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function chargingstation_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function chargingstation_sanitize_float( $input ) {
 ...
 */
function chargingstation_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function chargingstation_sanitize_html( $html ) {
 ...
 */
function chargingstation_sanitize_image( $image, $setting ) {
 ...
 */
function chargingstation_sanitize_nohtml( $nohtml ) {
 ...
 */
function chargingstation_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function chargingstation_sanitize_range_value( $number, $setting ) {
 ...
 */
function chargingstation_sanitize_select( $input, $setting ) {
 ...
 */
function chargingstation_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function chargingstation_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function chargingstation_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
